...
| 9 | [AuthN & AuthZ](module-3-advanced/authn-authz) · [Database patterns](module-3-advanced/database-patterns) · [SQLC vs the DSL](module-3-advanced/persistence-sqlc-vs-dsl) · [Schema migrations](module-3-advanced/schema-migrations) · [Transactions](module-3-advanced/transactions) · [Elasticsearch](module-3-advanced/elasticsearch) | 14 |
